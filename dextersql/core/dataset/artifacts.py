...
class SQLRuleCorrectionArtifact(BaseModel):
    sql_candidates_after_rule_correction: Optional[List[str]] = Field(default=None)
    rule_correction_applied_rules: Optional[Dict[str, List[str]]] = Field(default=None)
    rule_correction_time: Optional[float] = Field(default=None)
    rule_correction_llm_cost: Optional[Dict[str, Any]] = Field(default=None)
...
class PipelineArtifacts(BaseModel):
    ...
    sql_rule_correction: SQLRuleCorrectionArtifact = Field(default_factory=SQLRuleCorrectionArtifact)
...
STAGE_ARTIFACT_MODELS = {
    ...
    "sql_rule_correction": SQLRuleCorrectionArtifact,
...
STAGE_ARTIFACT_FIELDS = {
    ...
    "sql_rule_correction": (
        "sql_candidates_after_rule_correction",
        "rule_correction_applied_rules",
        "rule_correction_time",
        "rule_correction_llm_cost",
    ),
    "sql_selection": (
        "final_selected_sql",
        "sql_selection_time",
...
STAGE_VALIDATION_FIELDS = {
    ...
    "sql_rule_correction": STAGE_ARTIFACT_FIELDS["sql_rule_correction"],
