...
Override to a hosted API with: --backend openai  (no GPU required)
...
Usage:
  ...
  # Any OpenAI-compatible endpoint (OpenRouter, a hosted gateway, ...): use
  # --backend openai and point OPENAI_BASE_URL/OPENAI_API_KEY at it.
  python run_pipeline.py --db debit_card_specializing --backend openai --model openai/gpt-oss-120b
...
def main():
    ...
    parser.add_argument("--backend", type=str, default="gptoss",
                        choices=["gptoss", "gptoss120b", "qwen", "openai", "vllm_server"],
    ...
    parser.add_argument("--model", type=str, default=None,
                        help="Model ID override. "
                             ...
                             "openai default: openai/gpt-oss-120b")
    parser.add_argument("--device_map", type=str, default="auto",
                        help="HuggingFace device_map (default: auto). Ignored for openai.")
    parser.add_argument("--dtype", type=str, default=None,
                        help="Torch dtype: bfloat16 | float16 | float32 | auto "
                             "(default: bfloat16 on GPU, ignored for openai)")
    ...
    if not args.no_llm:
        ...
        _api_backends = {"openai", "vllm_server"}
