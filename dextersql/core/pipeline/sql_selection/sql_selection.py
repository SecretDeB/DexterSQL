...
import time
from dextersql.core.services import ArtifactStore, STAGE_ARTIFACT_FIELDS, configure_execution_service, configure_schema_service, get_execution_service, get_schema_service, load_stage_dataset, reset_execution_service, reset_schema_service
from dextersql.core.llm_extractor import LLMExtractor
...
class SQLSelectionRunner:
    ...
    def from_config(cls, app_config=None) -> "SQLSelectionRunner":
        ...
        return cls(
            ...
            input_save_path=app_config.sql_rule_correction_config.save_path,
    ...
    def _get_top_k_sql_candidates(self, data_item: DataItem) -> List[Tuple[str, str, float, float]]:
        ...
        for sql_candidate in data_item.sql_candidates_after_rule_correction:
    ...
    def _select_best_sql(self, data_item: DataItem) -> None:
        ...
        if len(top_k_sql_candidates) == 0:
            ...
            data_item.final_selected_sql = data_item.sql_candidates_after_rule_correction[0] if data_item.sql_candidates_after_rule_correction else "Error"
